  ...
  value: [
    {
      ...
      id: 'f78f9022-53cb-415d-810d-8c5d38aa0a72',
      ...
      appRoles: [
        ...
        },
        {
          allowedMemberTypes: ['Application'],
          description:
            'Allows the app to read, install, upgrade, and uninstall Teams apps for any user, without a signed-in user. Does not give the ability to read or write application-specific settings.',
        ...
        },
        {
          allowedMemberTypes: ['Application'],
          description:
            'Allows the app to read and write customer lockbox requests, business flows, and governance policy templates without a signed-in user.',
        ...
        },
        {
          allowedMemberTypes: ['Application'],
          description:
            'Allows the app to read and write admin consent requests, business flows, and governance policy templates without a signed-in user.',
        ...
        },
        {
          allowedMemberTypes: ['Application'],
          description:
            'Allows the app to read and write privileged access requests, business flows, and governance policy templates without a signed-in user.',
        ...
        },
        {
          allowedMemberTypes: ['Application'],
          description:
            'Allows the app to read admin consent requests, business flows, and governance policy templates without a signed-in user.',
        ...
        },
        {
          allowedMemberTypes: ['Application'],
          description:
            'Allows the app to read entitlement management requests, business flows, and governance policy templates without a signed-in user.',
        ...
        },
        {
          allowedMemberTypes: ['Application'],
          description:
            "Allows the app to send new activities to any users' teamwork activity feed, without a signed-in user.",
      ...
      oauth2Permissions: [
        ...
        },
        {
          ...
          userConsentDisplayName: 'Allow the app to manage itself in teams',
        ...
        },
        {
          ...
          userConsentDisplayName: 'Read all installed Teams apps',
          value: 'TeamsApp.Read.All',
        },
        {
          adminConsentDescription:
          ...
          userConsentDisplayName: 'Manage all Teams apps',
          value: 'TeamsApp.ReadWrite.All',
        },
        {
          adminConsentDescription:
        ...
        {
          adminConsentDescription:
            'Allows the app to read other users’ personal places that the signed-in user has delegate access to. Also allows read of the signed-in user’s personal places.',
        ...
        {
          adminConsentDescription:
            'Allows the app to read customer lockbox requests, business flows and governance policy templates on behalf of the signed-in user.',
          ...
          type: 'Admin',
          userConsentDescription:
            'Allows the app to read customer lockbox requests, business flows and governance policy templates on your behalf.',
          userConsentDisplayName: 'Read customer lockbox approval requests',
          value: 'ApprovalRequest.Read.CustomerLockbox',
        },
        {
          adminConsentDescription:
            'Allows the app to read admin consent requests, business flows, and governance policy templates on behalf of the signed-in user.',
          ...
          type: 'Admin',
          userConsentDescription:
            'Allows the app to read admin consent requests, business flows, and governance policy templates on your behalf.',
        ...
        {
          adminConsentDescription:
            'Allows the app to read privileged access requests, business flows, and governance policy templates on behalf of the signed-in user.',
          ...
          type: 'Admin',
          userConsentDescription:
            'Allows the app to read privileged access requests, business flows, and governance policy templates on your behalf.',
        ...
        {
          adminConsentDescription:
            "Allows the app to create new activities in the user's teamwork activity feed, and send new activities to other users' activity feed, on behalf of the signed-in user.",
        ...
        },
        {
          ...
          type: 'Admin',
          userConsentDescription:
            'Allows the app to read and write your organization’s identity (authentication) providers’ properties on your behalf.',
...
export function getGraphPermissions(...roleNames: RoleProps[]): PermissionProps {
  ...
  const found = principals.value.find((a) => a.appId === graph.id);
  if (!found) return rs;
